...
static void operation_node_write (Tree* node_ptr, FILE* output_file);

static void const_node_write (Tree* node_ptr, FILE* output_file);

static void var_node_write (Tree* node_ptr, FILE* output_file);

static void func_node_write (Tree* node_ptr, FILE* output_file);
...
int tree_dump_visual (Tree* tree_node)
{
    ...
    operation_node_write (tree_node, output_file);
    const_node_write (tree_node, output_file);
    var_node_write (tree_node, output_file);
    func_node_write (tree_node, output_file);
...
#define write_define_vis_(arg, side)                                                                                                                    \
        do{                                                                                                                                             \
            ...
            {                                                                                                                                           \
                Tree* node_ptr = tree_node->arg;                                                                                                        \
                operation_node_write (node_ptr, output_file);                                                                                           \
                const_node_write (node_ptr, output_file);                                                                                               \
                var_node_write (node_ptr, output_file);                                                                                                 \
                func_node_write (node_ptr, output_file);                                                                                                \
